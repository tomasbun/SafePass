...
namespace SafePass
{
    static class Program
    {
        ...
        public static string filename = "admin";
        public static string directory_path = @"c:\safepass";
        ...
        static public string EncryptData(string textData, string Encryptionkey)
        {
        ...
        static public string DecryptData(string EncryptedText, string Encryptionkey)
        ...
        static public string DecryptData_nopadding(string EncryptedText, string Encryptionkey)
        ...
        static public string file_location()
        {
            return directory_path + @"\" + ComputeSha256Hash(filename) + ".txt";
        }
